...
| binary | [crosstool-ng](http://crosstool-ng.org/) | ![Last Build](https://img.shields.io/docker/v/ctftools/crosstool-ng?label=built) Cross-compilers and cross-architecture tools. | <!--tool--><!--no-test-->
...
| forensiry | [scrdec18](https://gist.github.com/bcse/1834878) | ![Last Build](https://img.shields.io/docker/v/ctftools/scrdec18?label=built) A decoder for encoded Windows Scripts. | <!--tool-->
